"""
run.training.py contains wrapper code for training, will run mxnet trainer, will also allow use of tensorflow in future

"""

import argparse

from run.training.mxnet.train import train as mx_train
